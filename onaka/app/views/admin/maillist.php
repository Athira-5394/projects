		...
		<div class="fullcolumContents">
			...
			<div class="formarea mar_b30">
				<dl class="formitem clearfix">
					<dt>メールアドレス</dt>
					<dd><input type="text" name="emails" size="40" id="emails" style="ime-mode: disabled;" /></dd>
				</dl>
				<dl class="formitem clearfix">
					<dt>ステータス</dt>
					<dd><input type="checkbox" name="delflg" id="delflg" value="ON" /><label for="delflg">配信エラーアドレスも含む</label></dd>
				</dl>
			</div>
			<div id="list"></div>
		</div>
