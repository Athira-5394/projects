...
?>
			...
			<div class="formnote">
				<h2 class="h2_title_std">配信停止の手順</h2>
				<div class="mb30 ml30">
					<ol>
						<li>登録メールアドレス、表示中の文字認証（半角数字）を入力してください。</li>
						<li>個人情報の取り扱いに同意いただき、「配信を停止する」ボタンをクリックしてください。</li>
						<li>入力されたメールアドレスに解除案内のメールが届きます。</li>
						<li>メール本文に記載されているURLをクリックしてください。</li>
						<li>「配信停止」ボタンをクリックしてください。</li>
					</ol>
				</div>
				<div>
<?php
...
?>
			...
			<div class="inputbtnarea">
				<ul class="inputbtn_1set clearfix">
					<li><input type="button" id="policy" onclick="javascript:form_submit(document.entry);" value="メルマガ配信を停止する"></li>
				</ul>
				<ul class="clearfix">
